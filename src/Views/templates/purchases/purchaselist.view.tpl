<div class="flex items-center justify-between mb-4 mx-4">
    ...
    </div><section><h2 class="text-2xl font-bold mb-4 mx-4"> PURCHASE</h2>
...
</thead><tbody>{{foreach purchase}}<tr><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Purchases_Purchases&mode=DSP&={{}} ">{{id_purchase}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Purchases_Purchases&mode=DSP&={{}} ">{{purchase_date}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Purchases_Purchases&mode=DSP&={{}} ">{{total}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Purchases_Purchases&mode=DSP&={{}} ">{{details}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Purchases_Purchases&mode=DSP&={{}} ">{{usercod}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Purchases_Purchases&mode=DSP&={{}} ">{{payments}}</a></td>
            <td class"p-2 text-center">
                <a class="text-green-500 hover:text-green-700" href="index.php?page=Purchases_Purchases&mode=UPD&={{}}" >Edit</a> 
                <a class="text-red-500 hover:text-red-700" href="index.php?page=Purchases_Purchases&mode=DEL&={{}}" >Delete</a>
            </td>
	</tr>
