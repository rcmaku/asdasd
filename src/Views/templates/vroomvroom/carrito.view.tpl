<!-- Mantén tu HTML existente -->
<button id="openModal" class="floating-button" onclick="openModal()">
  <img src="/BetaGaming/public/imgs/utilities/grocery-cart.png">
</button>
...
<div id="modal" class="modal">
  <div class="modal-content">
    ...
    <div class="opciones_carrito">
      <form action="index.php?page=Landing_ProductosOferta" method="POST">
    ...
    {{endifnot ~isEmpty}}
    {{if ~isEmpty}}
    <h3>Ningún producto agregado</h3>
    {{endif ~isEmpty}}
  </div>
</div>
