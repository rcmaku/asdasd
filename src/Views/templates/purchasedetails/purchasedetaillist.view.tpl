...
</thead><tbody>{{foreach purchasedetail}}<tr><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Purchasedetails_Purchasedetails&mode=DSP&={{}} ">{{id_purchase}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Purchasedetails_Purchasedetails&mode=DSP&={{}} ">{{id_item_reference}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Purchasedetails_Purchasedetails&mode=DSP&={{}} ">{{quantity}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Purchasedetails_Purchasedetails&mode=DSP&={{}} ">{{unitary_price}}</a></td>
            <td class"p-2 text-center">
                <a class="text-green-500 hover:text-green-700" href="index.php?page=Purchasedetails_Purchasedetails&mode=UPD&={{}}" >Edit</a> 
                <a class="text-red-500 hover:text-red-700" href="index.php?page=Purchasedetails_Purchasedetails&mode=DEL&={{}}" >Delete</a>
            </td>
	</tr>
